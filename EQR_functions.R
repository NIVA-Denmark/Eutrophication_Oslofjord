...
.QElist <- read.table(file=paste0(input_folder,"indicatorQE.csv"),sep=";",header=T,comment.char="", quote='"')
...
.QEtype <- function(QE){
  ...
  biological <- c("Seagrass","Phytoplankton","Bottom fauna","Softbottom fauna","Bløtfunnsfauna","Macroalgae",
...
.HEATcategory <- function(QE){
  ...
  secondary <- c("Seagrass","Bottom fauna","Bløtfunnsfauna", "Softbottom fauna",
                 "Macroalgae","Oxygen","Ålegræs", "Bundfauna", "Makroalger")
